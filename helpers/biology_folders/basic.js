const basicBio = {
   ...
   entries: [
      ...
      },
      {
         ...
         image: null,
         data: [
            { "index": 0, "name": null, "value": "Change(Variable to be tested/changed)" },
            { "index": 0, "name": null, "value": "Organism(species, type, size, age, gender)" },
            { "index": 0, "name": null, "value": "Repeat(Haw many times repeated)" },
            { "index": 0, "name": null, "value": "Measure(Independent Variable)" },
            { "index": 0, "name": null, "value": "Measure(Verify Units)" },
            { "index": 0, "name": null, "value": "Same(Controlled variables))" },
            { "index": 0, "name": null, "value": "Same(Standardized variables))" }
         ]
      },
      {
         "index": 0,
